...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-npm/node_modules/npm/lib/visnup.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-npm/node_modules/npm/lib/visnup.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-npm/node_modules/npm/lib/</a> &#187; visnup.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports = visnup
...
&nbsp;
<span class="fstat-no" title="function not covered" >function visnup (args, cb) {</span>
<span class="cstat-no" title="statement not covered" >  handsomeFace.forEach(<span class="fstat-no" title="function not covered" >function (line) {</span></span>
<span class="cstat-no" title="statement not covered" >    output(line.map(<span class="fstat-no" title="function not covered" >function (ch) {</span></span>
<span class="cstat-no" title="statement not covered" >      return '\u001b[' + (ch ? '48;5;' + ch : ch) + 'm'</span>
    }).join(' '))
  })
&nbsp;
<span class="cstat-no" title="statement not covered" >  var c = args.shift()</span>
<span class="cstat-no" title="statement not covered" >  if (c) <span class="cstat-no" title="statement not covered" >npm.commands[c](args, cb)</span></span>
